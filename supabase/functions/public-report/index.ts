...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    return jsonResponse({
      ...
      queryBattery: evidence.query_battery ?? evidence.answer_tests ?? [],
      generativeAudit: evidence.generative_audit ?? null,
      categoryInference: evidence.category_inference ?? null,
      competitors: evidence.competitors ?? [],
      competitorTeardown: evidence.competitor_teardown ?? [],
      entityMap: evidence.entity_map ?? null,
      contentGaps: evidence.content_gaps ?? [],
      contentBlueprint: evidence.content_blueprint ?? [],
      strategicReadinessScore: evidence.strategic_readiness_score ?? null,
      strategicReadinessSummary: evidence.strategic_readiness_summary ?? null,
